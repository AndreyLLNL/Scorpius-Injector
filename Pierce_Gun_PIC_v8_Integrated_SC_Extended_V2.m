...
solenoid16_field = 0.0020;  % Drift solenoid 12 at 2390.89mm
solenoid17_field = 0.0020;  % Drift solenoid 13 at 2492.59mm
solenoid18_field = 0.0020;  % Drift solenoid 14 at 2615.55mm
solenoid19_field = 0.0020;  % Drift solenoid 15 at 2717.26mm
% ==================== EXTENDED SOLENOIDS 20-49 (NEW) ====================
solenoid20_field = 0.0020;  % Drift solenoid 16 at 2840.22mm
solenoid21_field = 0.0020;  % Drift solenoid 17 at 2941.92mm
solenoid22_field = 0.0020;  % Drift solenoid 18 at 3064.88mm
solenoid23_field = 0.0020;  % Drift solenoid 19 at 3166.58mm
solenoid24_field = 0.0020;  % Drift solenoid 20 at 3289.54mm
solenoid25_field = 0.0020;  % Drift solenoid 21 at 3391.25mm
solenoid26_field = 0.0020;  % Drift solenoid 22 at 3514.21mm
solenoid27_field = 0.0025;  % Drift solenoid 23 at 3615.91mm
solenoid28_field = 0.0025;  % Drift solenoid 24 at 3738.87mm
solenoid29_field = 0.0025;  % Drift solenoid 25 at 3840.58mm
solenoid30_field = 0.0025;  % Drift solenoid 26 at 3963.54mm
solenoid31_field = 0.0025;  % Drift solenoid 27 at 4065.24mm
solenoid32_field = 0.0030;  % Drift solenoid 28 at 4188.20mm
solenoid33_field = 0.0030;  % Drift solenoid 29 at 4289.93mm
solenoid34_field = 0.0030;  % Drift solenoid 30 at 4412.89mm
solenoid35_field = 0.0030;  % Drift solenoid 31 at 4514.59mm
solenoid36_field = 0.0035;  % Drift solenoid 32 at 4637.55mm
% solenoid37 = Steering magnet 3 at 4677.00mm (OFF)
solenoid38_field = 0.0035;  % Drift solenoid 33 at 4739.25mm
solenoid39_field = 0.0035;  % Drift solenoid 34 at 4862.21mm
solenoid40_field = 0.0035;  % Drift solenoid 35 at 4963.92mm
solenoid41_field = 0.0040;  % Drift solenoid 36 at 5086.88mm
solenoid42_field = 0.0040;  % Drift solenoid 37 at 5188.58mm
solenoid43_field = 0.0040;  % Drift solenoid 38 at 5311.54mm
% solenoid44 = Steering magnet 4 at 5377.00mm (OFF)
solenoid45_field = 0.0040;  % Drift solenoid 39 at 5413.24mm
solenoid46_field = 0.0040;  % Drift solenoid 40 at 5536.20mm
solenoid47_field = 0.0050;  % Drift solenoid 41 at 5637.91mm
solenoid48_field = 0.0050;  % Drift solenoid 42 at 5760.87mm
solenoid49_field = 0.0120;  % Drift solenoid 43 at 7448.00mm (LAST SOLENOID)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ENABLE_BETATRON_AVERAGING == true
    if ENABLE_MULTIPULSE == true
        ...
        fprintf('Snapshot P1 times: %d (t=%.0f-%.0f ns, mid-pulse reference)\n', ...
                N_SNAPSHOTS, SNAPSHOT_P1_TIMES(1)*1e9, SNAPSHOT_P1_TIMES(end)*1e9);
        
        % Estimate ion difference (late window now closer to pulse end)
        fprintf('Expected ion increase: ~50M → ~300M (6x growth)\n');
        fprintf('Late window ends 20ns before pulse end (better ion accumulation capture)\n');
    end
else
...
if ENABLE_ION_ACCUMULATION == true && mod(it, sc_interval) == 0
 ...
 if ~isempty(ir_ion)
    ...
    % FORCE COLUMN VECTORS (critical fix!)
    z_pts = z_pts(:);
    r_pts = r_pts(:);
...
if n_dep > 0
    ...
    enhancement_vec(in_gap) = 1.050 * 0.10; % Changed from 0.25 down to 0.10
    enhancement_vec(~in_gap) = 0.950 * 0.10;
    enhancement1 = 1.050 * 0.10;
    enhancement2 = 0.950 * 0.10;
...
if ENABLE_MULTIPULSE == true && ENABLE_INTERPULSE_SNAPSHOT == true && ENABLE_MULTIPULSE == true
